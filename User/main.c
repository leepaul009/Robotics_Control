...
/// Longitudinal and lateral offset from chassis center to wheel.
float OffsetLonCenter2Wheel, OffsetLatCenter2Wheel;
...
PID_PARAM pidParamMotorA_st;
PID_PARAM pidParamMotorB_st;
PID_PARAM pidParamMotorC_st;
PID_PARAM pidParamMotorD_st;
...
void initPIDParam()
{
    pidParamMotorA_st.velKp_f = 10;
    pidParamMotorA_st.velKi_f = 10;

    pidParamMotorB_st.velKp_f = 10;
    pidParamMotorB_st.velKi_f = 10;

    pidParamMotorC_st.velKp_f = 10;
    pidParamMotorC_st.velKi_f = 10;

    pidParamMotorD_st.velKp_f = 10;
    pidParamMotorD_st.velKi_f = 10;
}
